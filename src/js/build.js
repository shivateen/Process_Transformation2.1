/* Stage 2 · Discover & Fit — Build Engine (sub-view between Fitment and Discovery)
 * Makes visible what happens between "configure the action blocks" (Studio) and
 * "run the workflow" (Run & Govern): the configured blocks + fitment verdicts are
 * assembled into an executable agent chain, validated, and promoted to live.
 *
...
(function () {
  ...
  function empty() {
    var d = el("div", "fit-empty",
      '<div class="kv">Stage 2 · Discover & Fit — Build Engine</div>' +
  ...
  function head() {
    ...
    return el("div", "fit-head",
      '<div><div class="kv">Stage 2 · Discover & Fit — Build Engine</div>' +
